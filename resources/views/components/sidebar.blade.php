...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="{{ route('home') }}" class="brand-link"> <!--begin::Brand Image--> <img src="{{ asset('img') }}/logo.png" alt="AdminLTE Logo"  style="width: 100px; filter: brightness(0) invert(1); object-fit: cover;"> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light">Knowledge Hub</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
