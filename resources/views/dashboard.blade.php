@php use App\Models\Attachment;use App\Models\Meeting;use App\Models\Organization;use App\Models\User; @endphp
@extends('layout')
                    ...
                    <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 1-->
                        <div class="small-box text-bg-primary">
                            ...
                            <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                                 xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd"
                                      d="M4 3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v18h2a1 1 0 1 1 0 2H3a1 1 0 1 1 0-2h2V3zM7 5h2v2H7V5zm0 4h2v2H7V9zm0 4h2v2H7v-2zm4-8h2v2h-2V5zm0 4h2v2h-2V9zm0 4h2v2h-2v-2zm-4 4h6v2H7v-2z"></path>
                            </svg>
                        </div> <!--end::Small Box Widget 1-->
                    </div> <!--end::Col-->
